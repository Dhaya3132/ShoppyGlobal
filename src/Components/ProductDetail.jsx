...
const ProductDetail = () => {
    ...
    return (
        ...
        <div>
            <div className='w-full md:p-2 flex flex-col md:flex-row md:justify-center justify-center items-center p-5 gap-5 mt-10'>
                <div className='md:w-3/12 w-4/5 flex flex-shrink-0 bg-sky-50 border-2 border-sky-200 rounded-sm p-5'>
                ...
                <div className='md:w-1/2 w-full '>
                    ...
                    <div className='w-fit mt-5'>
                        <ul className='flex items-center'>
                            <li className='border-2 border-gray-200 p-3 md:text-lg text-sm'>{productData.warrantyInformation}</li>
                            <li className='border-2 border-gray-200 p-3 md:text-lg text-sm'>{productData.shippingInformation}</li>
                            <li className='border-2 border-gray-200 p-3 md:text-lg text-sm'>{productData.returnPolicy}</li>
                        </ul>
                    </div>
