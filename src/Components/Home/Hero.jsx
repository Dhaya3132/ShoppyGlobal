...
const Hero = () => {
    return (
        <div className='bg-bgBanner w-full h-full p-5'>
            <section className="p-5 flex justify-center items-center gap-5 mt-10">
                <div className='w-1/2'>
                    ...
                    <button className="px-12 py-2 text-white font-normal bg-Vermillion rounded-full mt-4 flex items-center gap-5">Start shopping <img src={upArrow_icon} alt="uparrow" className='w-3 h-3' /></button>
